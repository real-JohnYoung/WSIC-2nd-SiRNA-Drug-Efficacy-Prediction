...
if __name__ == '__main__':
    ...
    train_data, test_data = train_test_split(train_data, test_size=0.125, random_state=42)
    ...
    model = train_model(model, train_loader, val_loader, criterion, optimizer, 60, device)
